...
public class ForceConnectorHelper {
  ...
  private BayeuxClient getClient(int TIMEOUT, String DEFAULT_PUSH_ENDPOINT, String clientId,
                                 String clientSecret, String username, String password) throws Exception {
    // Authenticate via OAuth

    ClientSessionChannel.MessageListener subscriptionListener = (channel, message) -> LOG.debug("onMessage event: " + message.getJSON());

    LOG.debug("ClientID: " + clientId + " ClientSecret: " + clientSecret + " Username: " + username);
